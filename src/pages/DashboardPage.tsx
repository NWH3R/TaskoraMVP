...
export const DashboardPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (success === 'true' && product) {
      toast.success(`Successfully purchased ${decodeURIComponent(product)}!`);
      // Clean up URL
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="text-gray-600">
              Here's what's happening with your tasks today. Current plan: <span className="font-medium text-blue-600">{activePlan.name}</span>
            </p>
          </div>
